...
using ApiCatalogoJogos.IJogosService;
...
namespace ApiCatalogoJogos.Services
{
    ...
    {
        private readonly IjogosRepositorys _jogoRepository;

        public JogoServices(IjogosRepositorys jogoRepository)
        {
        ...
        public async Task<JogosViewModel> Inserir(JogoInputModel jogo)
        {
            ...
            if (entidadeJogo.Count > 0)
                throw new JogoJaCadatradoException();
